 ...
 * We sort the numbers from least significatn digit to most significant digit
 * We use counting sort as a sub-routine to sort
 */
...
const NUMBER_OF_POSSIBLE_DIGITS = 10; //0-9
...
export default class RadixSort extends Sort {
  ...
  /**
   * If it is an array of numbers, return log10(num), wich is the length of longest element
   * @param {*[]} array
   * @return {number}
   */
  getLengthOfLongestElement(array) {
    ...
    //acc accumulative value in the reduce operation
